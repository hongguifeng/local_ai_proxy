...
- [x] `DOC-002` P0 更新 README.cn.md。
- [x] `DOC-003` P0 更新安装、开发、测试、打包命令。
- [x] `DOC-004` P0 更新项目结构。
...
- [x] `CLEAN-008` P0 clean clone 只安装 Node 依赖即可开发和运行。
...
- [x] `REL-008` P0 正式 tag、artifact、checksum、回滚文档齐全。
