...
| 完成 | ID | 任务 | 依赖 | 状态 |
| --- | --- | --- | --- | --- |
| [ ] | STAT-01 | 统计数据模型、索引与迁移 | 无 | 未开始 |
| [ ] | STAT-02 | repository 总量与分组查询 | STAT-01 | 未开始 |
| [ ] | STAT-03 | repository 趋势 bucket 查询 | STAT-01 | 未开始 |
| [ ] | STAT-04 | UsageStatisticsService 合并与口径 | STAT-02、03 | 未开始 |
| [ ] | STAT-05 | 管理 API、schema 与鉴权 | STAT-04 | 未开始 |
| [ ] | STAT-06 | CSV 导出接口 | STAT-05 | 未开始 |
| [ ] | STAT-07 | 页面导航、筛选和状态管理 | STAT-05 | 未开始 |
| [ ] | STAT-08 | 总体分布饼图与指标切换 | STAT-07 | 未开始 |
| [ ] | STAT-09 | 明细表格与趋势柱状图 | STAT-07 | 未开始 |
